...
pause
echo DONE!
echo IF YOU WANT TO REMOVE ME AND PUT ME BACK TO THE GRAVE, DELETE THE REMOVEFROMSURFACE.BAT FILE, THEN RESTART YOUR COMPUTER AND RUN STEAM. IT WILL AUTOMATICALLY UPDATE AND REMOVE ME.
pause
echo START ME???
pause
start steam.exe
